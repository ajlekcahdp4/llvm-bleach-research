...
+ Различные архитектуры команд (ISA). Процессорные архитектуры являются главной
  ...
  инструкций архитектуры могут также отличаются размером инструкций. Например, X86
...
+ Соглашением о вызовах (ABI -- Application Binary Interface) называется документ,
  описывающий обязаности вызывающей (caller) и вызываемой (callee) функций.
