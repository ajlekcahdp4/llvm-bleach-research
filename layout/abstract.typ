  ...
  align(
    center, text(
      font: fonts.sans, 1.5em, weight: 100, [
        Проблема бинарной совместимости программ и их переносимости на разные архитектуры
        ...
        за счёт паттерн матчинга. Такие решения усложняют поддержание новых
        исходных архитектур, ввиду чего поддержка относительно молодой микропроцессорной
        архитектуры RISC-V в существующих трансляторах либо отсутствует, либо сильно
        ограничена.
